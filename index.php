...
<html lang="de">
  ...
  <body>
    ...
    if ($login) {
        ...
        echo "<a href='https://www.strava.com/oauth/authorize?client_id=" . $strava_client . "&response_type=code&scope=activity:read_all,profile:read_all,activity:write&redirect_uri=http://dev.florian-timm.de/strava/";
